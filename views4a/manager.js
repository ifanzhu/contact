...
var Manager = React.createClass({
  ...
  render: function(){
    ...
    var items = ['修改密码', '增加联系人', '删除联系人',  '发布公告'];
     var names = ['ModifyPassword', 'AddUser', 'DeleteUser', 'PostMessage'];
    var components = [ModifyPassword, AddUser, DeleteUser, PostMessage];
    var JSXDOM = [];
    for(var i in items){
      JSXDOM.push(
        <TouchableOpacity key={items[i]} onPress={this._loadPage.bind(this, names[i], items[i])}>
